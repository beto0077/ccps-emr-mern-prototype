...
function SocialWorkInfo1Form() {
  ...
  const [newMember, setNewMember] = useState({ name: '', relationship: '', age: '', nationality: '', occupation: '', id: '' });
    ...
    <div style={{ display: "block", margin: "auto", width: 400, padding: 30 }}>
      <Form onSubmit={handleSubmit}>
        <h1 className="text-center mb-4">
          {params.id ? "Edit Social Work Info" : "Nueva información de trabajo social"}
        </h1>
        ...
        <Form.Group controlId="formInsurance" className="mb-3">
          ...
          <div>
            <Form.Check
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, insurance: true})}
            />
            <Form.Check
              inline
              type="radio"
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, insurance: false})}
            />
          </div>
        </Form.Group>
        ...
        <Form.Group controlId="formPension">
          ...
          <div>
            <Form.Check
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, pension: true})}
            />
            <Form.Check
              inline
              type="radio"
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, pension: false})}
            />
          </div>
        </Form.Group>
        ...
        <Form.Group controlId="formSupportNetwork">
          ...
          <div>
            <Form.Check
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, support_network: true})}
            />
            <Form.Check
              inline
              type="radio"
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, support_network: false})}
            />
          </div>
        </Form.Group>
        ...
        <Form.Group controlId="formKnowsDiagnosis" className="mb-3">
          ...
          <div>
            <Form.Check
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, knows_diagnosis: true})}
            />
            <Form.Check
              inline
              type="radio"
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, knows_diagnosis: false})}
            />
          </div>
        </Form.Group>
        ...
        <Form.Group controlId="formHeadOfFamily" className="mb-3">
          ...
          <div>
            <Form.Check
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, head_of_family: true})}
            />
            <Form.Check
              inline
              type="radio"
              ...
              onChange={()=>setSocialWorkInfo({...socialWorkInfo, head_of_family: false})}
            />
          </div>
        </Form.Group>
        ...
        <Button className="mt-3 mb-4" variant="primary" onClick={handleAddFamilyMember}>Agregar nuevo familiar</Button>
        ...
        {familyGroup.map((member, index) => (
            <div key={index}>
                <p>Nombre: {member.name} <br/>Parentesco: {member.relationship}<br/>Edad: {member.age}<br/>Nacionalidad: {member.nationality}<br/>Ocupación: {member.occupation}<br/>Cédula: {member.id}</p>
                <Button className="mb-3" variant="danger" onClick={() => handleRemoveFamilyMember(index)}>Remover</Button>
            </div>
        ))}
          </>
        )}
