        ...
        <>
          ...
          <div className="text-center mt-5">
            <Button
              ...
              size="lg"
              onClick={() =>
                navigate(`/createSocialWorkInfo1`, { state: { id: params.id } })
              }
                    ...
                    <Table>
                      <tbody>
                        ...
                        <tr>
                          <th>Red apoyo</th>
                          <td>
                            {socialWorkInfo1.support_network ? "Sí" : "No"}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            {socialWorkInfo1.knows_diagnosis ? "Sí" : "No"}
                          </td>
                        </tr>
                        <tr>
                          <th>Referido por</th>
                        ...
                        <tr>
                          ...
                          <td>
                            {socialWorkInfo1.head_of_family ? "Sí" : "No"}
                          </td>
                        </tr>
                        <tr>
                          <th>Estado civil</th>
