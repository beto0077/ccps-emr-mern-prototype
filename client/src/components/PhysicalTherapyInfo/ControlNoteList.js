...
function ControlNoteList() {
  ...
  const { controlNotes, loadControlNotes, deleteControlNote } =
    useControlNoteContext();
      ...
      {error ? (
        ...
        <div className="bg-dark" style={{ minHeight: `${availableHeight}px` }}>
          ...
          <div className="text-center">
            <Button
              disabled={
                activeUser.specialty === "Terapia fisica" ? false : true
              }
              variant="primary"
              size="lg"
              onClick={() =>
                navigate(`/createControlNote`, {
                  state: { id: therapyInfoId, patientId: params.id },
                })
              }
              className="mx-2 my-2 my-lg-3"
            >
            ...
            <Row>
              <Col>
                          ...
                          <tr key={controlNote.control_note_id}>
                            ...
                            <td>
                              <Button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/controlNote/${controlNote.control_note_id}`
                                  )
                                }
                              >
                                Más detalles
                ...
                <Button
                  ...
                  type="button"
                  onClick={() =>
                    navigate(`/physicalTherapyDashboard/${params.id}`)
                  }
                >
                  Volver al panel
                </Button>
