...
function EquipmentLoanForm() {
  ...
  useEffect(() => {
    const loadEquipmentLoan = async () => {
      if (params.id) {
        ...
        if (!loadedLoan.loan_completed && (loadedLoan.return_date === null || loadedLoan.return_date === 'NULL')) {
    ...
    <h1>Prestamo de equipo</h1>
      <Form onSubmit={handleSubmit}>
        <Form.Group controlId="deliveryDate" className="mb-3">
          ...
          <Form.Control disabled={params.id} type="date" name="delivery_date" value={loan.delivery_date} onChange={handleChange} required />
        </Form.Group>
        ...
        <Form.Group controlId="description" className="mb-3">
          ...
          <Form.Control disabled={params.id} type="text" name="description" value={loan.description} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="plate" className="mb-3">
          <Form.Label>Placa</Form.Label>
          <Form.Control disabled={params.id} type="text" name="plate" value={loan.plate} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="quantity" className="mb-3">
          <Form.Label>Cantidad</Form.Label>
          <Form.Control disabled={params.id} type="number" name="quantity" value={loan.quantity} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="beneficiary" className="mb-3">
          <Form.Label>Beneficiario</Form.Label>
          <Form.Control disabled={params.id} type="text" name="beneficiary" value={loan.beneficiary} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="referenceIssuedByDoctor" className="mb-3">
          <Form.Label>Referencia emitida por el médico</Form.Label>
          <Form.Control disabled={params.id} type="text" name="reference_issued_by_doctor" value={loan.reference_issued_by_doctor} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="personReceivingEquipment" className="mb-3">
          <Form.Label>Persona que recibe el equipo</Form.Label>
          <Form.Control disabled={params.id} type="text" name="person_receiving_equipment" value={loan.person_receiving_equipment} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="idNumber" className="mb-3">
          <Form.Label>Cédula de persona que recibe el equipo</Form.Label>
          <Form.Control disabled={params.id} type="text" name="id_number" value={loan.id_number} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="exactAddress" className="mb-3">
          <Form.Label>Dirección exacta</Form.Label>
          <Form.Control disabled={params.id} type="text" name="exact_address" value={loan.exact_address} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="phoneNumber" className="mb-3">
          <Form.Label>Número de teléfono</Form.Label>
          <Form.Control disabled={params.id} type="text" name="phone_number" value={loan.phone_number} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="contractNumber" className="mb-3">
          <Form.Label>Número de contrato</Form.Label>
          <Form.Control disabled={params.id} type="text" name="contract_number" value={loan.contract_number} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="justification" className="mb-3">
          <Form.Label>Justificación</Form.Label>
          <Form.Control disabled={params.id} as="textarea" rows={3} name="justification" value={loan.justification} onChange={handleChange} required />
        </Form.Group>
        ...
        <Form.Group controlId="preparedBy" className="mb-3">
          ...
          <Form.Control disabled={params.id} type="text" name="prepared_by" value={loan.prepared_by} onChange={handleChange} required />
        </Form.Group>
        <Form.Group controlId="preparationDate" className="mb-3">
          <Form.Label>Fecha de creación</Form.Label>
          <Form.Control disabled={params.id} type="date" name="preparation_date" value={loan.preparation_date} onChange={handleChange} required />
        </Form.Group>
        {params.id ? (
  <Form.Group controlId="loanCompleted">
    ...
    >
      {loan.loan_completed ? "Prestamo completado" : "Marcar como completado"}
    </Button>
  </Form.Group>
) : null}
