...
function PsychologyInfo2Form() {
  ...
  const { createPsychologyInfo2, getPsychologyInfo2, updatePsychologyInfo2 } =
    usePsychologyInfo2Context();
    ...
    <>
      ...
      >
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group
            controlId="formOccupationalEducationalAspects"
            className="mb-3"
          >
          ...
          <Form.Group
            controlId="formFamilyAspectsFamilyDiagram"
            className="mb-3"
          >
