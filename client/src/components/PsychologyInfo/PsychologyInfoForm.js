...
function PsychologyInfoForm() {
  ...
  const getFinalTreatmentPlans = () => {
    return treatmentPlans.map((plan, index) => {
      if (plan.selected_intervention === "Other" && customTreatmentInputs[index]) {
      ...
      >
        <Form onSubmit={handleSubmit}>
            ...
            {diagnosisOncologicalConditions.map((condition, index) => (
              <div key={index}>
                ...
                >
                  ...
                  <option value="CA de cérvico-uterino">CA cérvico-uterino</option>
                  ...
                  <option value="CA piel y partes blandas">CA piel y partes blandas</option>
          ...
          <Form.Group controlId="diseaseStatuses">
            <Form.Label><h3 className="text-center mb-2 mt-2">Actualización de enfermedad médica</h3> </Form.Label>
            {diseaseStatuses.map((status, index) => (
              <div key={index}>
                ...
                >
                  <option value="">Seleccione una opción</option>
                  <option value="Recién diagnosticado">Recién diagnosticado</option>
          ...
          <Form.Group controlId="treatmentHistories" className="mt-3">
            <Form.Label><h3>Tratamientos</h3></Form.Label>
          ...
          <Form.Group controlId="emotionalPsychologicalSymptoms" className="mt-3">
            <Form.Label><h3>Síntomas afectivos</h3></Form.Label>
            {emotionalPsychologicalSymptoms.map((symptom, index) => (
              <div key={index}>
                ...
                >
                  ...
                  <option value="Negación a la enfermedad">Negación a la enfermedad</option>
                  ...
                  <option value="Sentimientos de culpa">Sentimientos de culpa</option>
                  <option value="Ansiedad">Ansiedad</option>
                  <option value="Depresión">Depresión</option>
                  <option value="Preocupación">Preocupación</option>
                  <option value="Náuseas y vómitos anticipados">Náuseas y vómitos anticipados</option>
                  <option value="Pérdida de imagen corporal">Pérdida de imagen corporal</option>
                  <option value="Alteración del apetito">Alteración del apetito</option>
                  <option value="Alteraciones del sueño">Alteraciones del sueño</option>
                  <option value="Alteración en la sexualidad">Alteración en la sexualidad</option>
                  <option value="Alteración en relación de pareja">Alteración en relación de pareja</option>
                  <option value="Alteraciones en la relación familiar">Alteraciones en la relación familiar</option>
                  <option value="Ideas de abandono a tratamientos">Ideas de abandono a tratamientos</option>
          ...
          <Form.Group controlId="psychological_psychiatric_history" className="mt-4">
            ...
            {treatmentPlans.map((plan, index) => (
              <div key={index}>
                ...
                >
                  ...
                  <option value="Técnicas de relajación">Técnicas de relajación</option>
                  <option value="Reestructuración cognitiva">Reestructuración cognitiva</option>
                  <option value="Técnicas de manejo y control de la atención">Técnicas de manejo y control de la atención</option>
                  <option value="Manejo de técnicas de comunicación">Manejo de técnicas de comunicación</option>
                  <option value="Técnicas de manejo de duelo y paliativo">Técnicas de manejo de duelo y paliativo</option>
                  <option value="Duelo anticipatorio">Duelo anticipatorio</option>
                  <option value="Other">Otro</option>
                </Form.Select>
          ...
          <Form.Group controlId="recommendations">
            <Form.Label><h3>Recomendaciones</h3></Form.Label>
            <Form.Control
              as="textarea"
              rows={5}
